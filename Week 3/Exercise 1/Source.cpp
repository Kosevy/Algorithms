#include "CControladoraAlmacen.h"
...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            {
                cout << "NO HAY PROVEEDORES REGISTRADOS. INGRESE UN PROVEEDOR" << endl;
            }
            else
            {
                controladora->InsertarProducto();
                cout << endl << "PRODUCTO INGRESADO EXITOSAMENTE" << endl;
            }
            system("pause>0");
            break;
        case 2:
            ...
            cout << endl << "PROVEEDOR INGRESADO EXITOSAMENTE" << endl;
            system("pause>0");
            break;
        case 3:
            system("cls");
            ...
            {
                cout << "NO HAY PRODUCTOS REGISTRADOS. INGRESE UN PRODUCTO" << endl;
            }
            else
            {
        ...
        case 5:
            ...
            if (!controladora->existenProductos() || !controladora->existenProveedores())
            {
                cout << "REGISTRE POR LO MENOS UN PRODUCTO Y UN PROVEEDOR" << endl;
            }
            else
            {
