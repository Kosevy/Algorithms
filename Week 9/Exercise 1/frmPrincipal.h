...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->lblMstrAreaDerecha->Click += gcnew System::EventHandler(this, &MyForm::lblMstrAreaDerecha_Click);
			   // 
			   // lblLado2
			   // 
...
#pragma endregion
		   ...
		   Void comboBox1_SelectedIndexChanged(Object^ sender, EventArgs^ e)
		   {
			   ...
			   if (selectedFigura == "Circulo")
			   {
				   ...
				   lblMstrarAreaizq->Enabled = true;
				   lblMstrArea->Enabled = true;
				   lblMstrAreaDerecha->Enabled = false;
			   }
			   else if (selectedFigura == "Cuadrado")
			   {
				   //selectedFigura += "";
				   ...
				   lblLado2->Enabled = false;
				   txbxLado2->Enabled = false;
				   lblRadio->Enabled = false;
				   txbxRad->Enabled = false;
				   lblMstrarAreaizq->Enabled = false;
				   lblMstrArea->Enabled = false;
			   }
			   else if (selectedFigura == "Rectangulo")
			   {
			   ...
			   else if (selectedFigura == "Elipse")
			   {
				   ...
				   txbxRad->Enabled = false;
				   lblMstrarAreaizq->Enabled = false;
				   lblMstrAreaDerecha->Enabled = true;
				   lblMstrArea->Enabled = false;
			   }
	...
	private: System::Void lblMstrAreaDerecha_Click(System::Object^ sender, System::EventArgs^ e) {
	}
};
